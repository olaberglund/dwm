...
static const char *rs0[]      = { "/bin/sh", "-c", "rs 0", NULL };
static const char *rs1[]      = { "/bin/sh", "-c", "rs 1", NULL };
static const char *rs2[]      = { "/bin/sh", "-c", "rs 2", NULL };
static const char *rs3[]      = { "/bin/sh", "-c", "rs 3", NULL };
static const char *rs4[]      = { "/bin/sh", "-c", "rs 4", NULL };
static const char *rs5[]      = { "/bin/sh", "-c", "rs 5", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_KP_Insert,      spawn,					 {.v = rs0 } },
	{ MODKEY,                       XK_KP_End,      spawn,					 {.v = rs1 } },
	{ MODKEY,                       XK_KP_Down,      spawn,					 {.v = rs2 } },
	{ MODKEY,                       XK_KP_Next,      spawn,					 {.v = rs3 } },
	{ MODKEY,                       XK_KP_Left,      spawn,					 {.v = rs4 } },
	{ MODKEY,                       XK_KP_Begin,      spawn,					 {.v = rs5 } },
